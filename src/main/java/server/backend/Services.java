...
public class Services
{
    ...
    public String login(String username, String password)
    {
       ...
       //Her bliver nye bruger tildelt og loginkey bliver lavet n�r brugeren logger ind
    ...
    {
    	//den nuværende user indikeret af "this", bliver logget ud
        User user = this.getUser(id);
        if(user == null)
        {
            return false;
        }
        //idet logout finder sted sættes loginkey igen til 0 
