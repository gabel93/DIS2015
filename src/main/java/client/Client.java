...
//Her bliver de forskellige variabler instantieres
    ...
    public void start()
    {
        ...
        //Etablerer forbindelse og opretter streams
            ...
            while(true)
            {
                try
                {
                    int option = this.readOption("1. Create a game 2. Set game commands 3. Get highscore(s) 4. Delete a game 5. Start a game 6. Show a game 7. Logout : ", 1, 7);
                    switch(option)
                    {
    ...
    private boolean login()
    {
      ...
      //Da der ved login bliver generet et loginkey kan vi antage, at hvis loginkey ikke er lig nul, vil brugeren være logget ind.
        System.out.println(successful ? "You have now logged in successfully." : "You have failed to login.");
  ...
  //Creategame request -->Server
    ...
    private void setCommands()
    {
        ...
        System.out.println(successful ? "Commands is set successfully." : "Failed to set required commands.");
    }
    ...
    private void startGame()
    {
        ...
        if(game == null)
        {
            System.out.println("No such game excist.");
            return;
        }
